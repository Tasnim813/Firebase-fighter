...
import MyContainer from "../Componenet/MyContainer";
import { createUserWithEmailAndPassword } from "firebase/auth";
import { auth } from "../Firebse/Firebase_Config";
...
const Signup = () => {
    ...
    const handleSignup = (e) => {
        ...
        console.log('sign up btn', { email, password })
        ...
        if (!regex.test(password)) {
            toast.error('❌ Password must be at least 8 characters long, include at least one uppercase letter, one lowercase letter, one number, and one special character (!@#$%^&* etc), and must not contain spaces.')
            return;

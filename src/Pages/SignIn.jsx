...
const Signin = () => {
    ...
    const handleSignin=(e)=>{
        ...
        .then(result=>{
            console.log(result)
            setUser(result.user)
            toast.success('sigIn Succeddfull')
        })
        .catch(e=>{
            console.log(e)
    ...
    <div className="min-h-[calc(100vh-20px)] flex items-center justify-center bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 relative overflow-hidden">
      ...
      <MyContainer>
       ...
       {user ? (<div className="text-center space-y-3">
        ...
        <h2 className="text-xl font-semibold">{user?.providerId}</h2>
        <button onClick={handleSignOut} className="bg-purple-500 text-white px-4 py-2 rounded-md font-semibold cursor-pointer">Sign out</button>
